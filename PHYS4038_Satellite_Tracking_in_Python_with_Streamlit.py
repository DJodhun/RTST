...
#Defining useful data for Skyfield and constants
...
opp = overhead_polar_plot(passes[0])

#%%
#STREAMLIT PLOTS

st.write("# Satellite Plotting in Python")
st.set_option('deprecation.showPyplotGlobalUse', False)

option = st.selectbox(
    "Select a set of orbital elements",
    ("GPS Satellites", "GLONASS Satellites", "Space Stations", "Starlink (WIP)", "Military Satellites"))

ISS = "ISS (ZARYA) 1 25544U 98067A   22353.76579140  .00011344  00000+0  20600-3 0  9997 2 25544  51.6432 137.2564 0003570 175.9484 324.6865 15.50061212373969"

if option == "GPS Satellites":
    url = "http://celestrak.org/NORAD/elements/gp.php?GROUP=gps-ops&FORMAT=tle"
elif option == "Space Stations":
    url = "https://celestrak.org/NORAD/elements/gp.php?GROUP=stations&FORMAT=tle"
elif option == "Military Satellites":
    url = "https://celestrak.org/NORAD/elements/gp.php?GROUP=military&FORMAT=tle"
elif option == "GLONASS Satellites":
    url = "https://celestrak.org/NORAD/elements/gp.php?GROUP=glo-ops&FORMAT=tle"
elif option == "Debris (IRIDIUM 33)":
...
# st3Dplot = orbitalElementPlotter3D(time, length)
# #placeholder.pyplot(orbitalElementPlotter3D(time, length))
# st.pyplot(st3Dplot)

# st.pyplot(orbitalElementPlotter2D(time, length))

# st.pyplot(opp)

placeholder = st.empty()
# st3Dplot = orbitalElementPlotter3D()
placeholder.pyplot(orbitalElementPlotter3D(time, length))
